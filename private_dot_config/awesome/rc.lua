...
-- beautiful.init("~/.config/awesome/themes/sleek/theme.lua")
local theme_path = string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "sleek")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "s", function() awful.util.spawn("flameshot gui", false) end,
    		  {description = "start flameshot to take a screenshot"})
)
